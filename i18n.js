...
const I18n = {
    ...
    messages: {
        zh: {
            ...
            'materials.item': '材质',
            'materials.texture': '纹理贴图',
            'materials.noTexture': '无纹理',
            'materials.loadTexture': '📁 加载纹理',
            'materials.removeTexture': '🗑️ 移除',
            'materials.texturePresets': '材质预设',
            'materials.presetSilk': '丝绸',
            'materials.presetDenim': '牛仔',
            'materials.presetLeather': '皮革',
            'materials.presetCotton': '棉布',
            'materials.presetVelvet': '天鹅绒',
            'materials.presetMetal': '金属',
            'materials.textureLoaded': '纹理已加载',
            'materials.textureRemoved': '纹理已移除',
        ...
        en: {
            ...
            'materials.noTexture': 'No texture',
            'materials.loadTexture': '📁 Load Texture',
            'materials.removeTexture': '🗑️ Remove',
            'materials.texturePresets': 'Material Presets',
            'materials.presetSilk': 'Silk',
            'materials.presetDenim': 'Denim',
            'materials.presetLeather': 'Leather',
            'materials.presetCotton': 'Cotton',
            'materials.presetVelvet': 'Velvet',
            'materials.presetMetal': 'Metal',
            'materials.textureLoaded': 'Texture loaded',
            'materials.textureRemoved': 'Texture removed',
